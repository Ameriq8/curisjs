/**
 * @curisjs/db - Node.js Server Example
 *
 * Simple Todo API demonstrating @curisjs/db with Node.js runtime
 *
 * Run: node --loader ts-node/esm examples/node-server.ts
 */

import { createApp, json } from '@curisjs/core';
import { Model, schema, createDatabase, databaseMiddleware } from '../src/index.js';
